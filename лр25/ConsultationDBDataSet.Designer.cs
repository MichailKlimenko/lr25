...
namespace лр25.ConsultationDBDataSetTableAdapters {
...
SELECT Id, FullName, Subject, Date, TimeSlot, IsBooked FROM Consultations WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::лр25.Properties.Settings.Default.ConsultationDBConnectionString;
        }
